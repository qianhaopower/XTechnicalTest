...
5. Use Autofac to create an IOC. Two type of service (InvoiceBasicService and InvoiceAdvancedService) has been registered on application start up via their interface.
   ...
   Basic service performs all original calculation. AdvancedService is similar but allowing passing in Invoices/InvoiceLines as parameter. They all inherits from a abstract base service.
...
8. Add logging using standard .NET logging facility. Setup is in App.config.
